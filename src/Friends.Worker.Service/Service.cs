...
namespace Friends.Worker.Service
{
    /// <summary>
            ...
            if (cancellationToken.IsCancellationRequested == false)
            {
                ...
                services.AddRebus(configure =>
                {
                    return configure
                        ...
                        .Transport(t => t.UseAzureServiceBus(connectionStringNameOrConnectionString: connString, inputQueueAddress: "friends-input"))
                        .Options(o => o.SimpleRetryStrategy("friends-error"));
                });
